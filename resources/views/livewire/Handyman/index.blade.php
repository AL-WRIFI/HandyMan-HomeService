...
{{--
                                            ...
                                            <div id="{{'demo'.$order->id}}" class="mt-1 collapse show"
                                    ...
                                    <div class="row px-2" style="box-sizing: border-box;">
                                        <button class="col-3 col-md-3 p-0  btn btn-outline-success "
                                            style="width: 60%;height: 23px;justify-content: center;display: flex;border-radius: 2.1px;border: 0.3px #28a745 solid;"
                                            wire:click="approvedOrder({{$order->id}})">
                                            <h5 style=" margin: 0;font-size: 15px;">قبول</h5>
                                        </button>
                                        <button class="col-3 col-md-3 p-0 btn btn-outline-danger "
                                            style="width: 60%;height: 23px;justify-content: center;display: flex;border-radius: 2.1px;border: 0.3px #dc3545 solid;"
                                            wire:click="rejectOrder({{$order->id}})">
                                            <h5 style="margin: 0; font-size: 15px;">رفض</h5>
                                        </button>
